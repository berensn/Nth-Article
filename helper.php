...
abstract class ModArticlesNewsHelper
{
	 ...
	 *
	 * @param   \Joomla\Registry\Registry  
	 *
	 * @return  mixed
	 *
	 * @since 1.6
	...
	public static function getList(&$params)
	{
		...
		$model->setState('list.limit', 50); // set to 0 to show all
		...
		foreach ($items as &$item)
		{
			...
			$item->introtext = JHtml::_('content.prepare', $item->introtext, '', 'mod_articles_nth.content');
